...
if __name__ == '__main__':
    ...
    parser.add_argument('-i','--image', default='./', help='image to be classified.')
    parser.add_argument('-m','--model_file', default='./quantized_model.nb', help='model to be executed.')
    parser.add_argument('-l','--label_file', default='./stai_mpu_python_example/labels_idid_cropped.txt', help='name of labels file.')
    parser.add_argument('--input_mean', default=127.5, help='input_mean')
    parser.add_argument('--split', help='train, val, test')
    parser.add_argument('--cl', help='broken, healthy')
